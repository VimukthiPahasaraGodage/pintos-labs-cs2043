...
struct thread
  {
    ...
    int masked_priority;                /* Priority masked by the priority donation */
    ...
    struct lock *wait_on_lock;          /* The lock the thread is waiting for(nested donation) */
    struct list locks_holding;          /* The list of lock the thread is holding(multiple donations) */
